...
control SwitchIngress(
    ...
    action Layer0_Process(bit <10> offset){ 
        ...
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[7:0];
    ...
    action BuildInput(){
        meta.bnnInput = (meta.bnnInput + (bit <64>) meta.feature0) << 7;
        meta.bnnInput = (meta.bnnInput + (bit <64>) meta.feature1) ;
    }
