...
control SwitchIngress(
    ...
    action extract_feature0(out bit<15> meta_code, bit<15> tree){
        meta_code = tree;
    }

    action extract_feature1(out bit<16> meta_code, bit<16> tree){
        meta_code = tree;
    }
    ...
    table lookup_leaf_id3 {
        key = { meta.code_f0[12:10]:exact;
                meta.code_f1[11:9]:exact;
    ...
    table lookup_leaf_id4 {
        key = { meta.code_f0[14:13]:exact;
                meta.code_f1[15:12]:exact;
